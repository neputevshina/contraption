...
type nvgParams interface {
	...
	renderTriangles(paint *Paint, scissor *nvgScissor, vertexes []Vertex)
	renderTriangleStrip(paint *Paint, scissor *nvgScissor, vertexes []Vertex)
	renderDelete()
}
...
func (c *nvgPathCache) allocVertexes(n int) []Vertex {
