...
func (p *glParams) renderTriangles(paint *Paint, scissor *nvgScissor, vertexes []Vertex) {
	c := p.context
...
func (p *glParams) renderTriangleStrip(paint *Paint, scissor *nvgScissor, vertexes []Vertex) {
	c := p.context
